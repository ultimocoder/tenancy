<div class="leftbar">
    <a href="{{route('home')}}" class="logo text-black text-center">
        ...
        <div class="accordion-item">
            <h2 class="accordion-header">
                <!-- <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#menu1" aria-expanded="true" aria-controls="menu1">
                    <a href="javascript:void(0)" class="text-dark" onclick="window.location.href='{{route('landlord.tenant-information')}}'">Tenant Information</a>
                </button> -->
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#menu1" aria-expanded="true" aria-controls="menu1">
                    Tenant Information
                </button>
