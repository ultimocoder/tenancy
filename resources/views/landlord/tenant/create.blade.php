                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lease_start_date" autocomplete="off" id="lease_start_date" value="{{old('lease_start_date')}}" class="form-control form-control-sm date" placeholder="Enter start date">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">Lease end date</label>
                                    <input type="text" name="lease_end_date" autocomplete="off" value="{{old('lease_end_date')}}" class="form-control form-control-sm date" placeholder="Enter end date">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
