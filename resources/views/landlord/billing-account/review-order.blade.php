                            ...
                            <div class="col-sm-4">
                                <div class="page-card">
                                    ...
                                    <table class="table fs-16">
                                        <tr><td>@if($pid == 1) Single Unit @elseif($pid == 2) Multi Unit @else Commercial @endif plan</td><td class="text-end">@if($cycle == 'monthly')  ${{$finalCost}}  @else ${{$finalCost}}  @endif</td></tr>
                                        <tr><td>Subtotal</td><td class="text-end">@if($cycle == 'monthly')  ${{$finalCost}}  @else ${{$finalCost}}  @endif</td></tr>
