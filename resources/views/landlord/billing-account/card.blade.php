                            ...
                            <div class='row'>
                                ...
                                <div class='col-sm-6 required'>
                                    <div class="form-group">
                                        ...
                                        <input class='form-control postal_code' size='4' required="" minlength="5" maxlength="5" name="postal_code" type='text' value="{{$request->postal_code}}">
                                    </div>       
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                <div class='col-sm-12 required'>
                                    <div class="form-group">
                                        ...
                                        <input autocomplete='off' class='form-control card-number' minlength="16" maxlength="16" size='20' type='text' placeholder="Reconfirm the card number">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class='form-row row'>
                                <div class='col-xs-12 col-md-4 form-group cvc required'>
                                    <label class='control-label'>CVC</label> <input autocomplete='off'
                                        ...
                                        type='text' placeholder="" minlength="3" maxlength="3">
                                </div>
                                <div class='col-xs-12 col-md-4 form-group expiration required'>
                                    <label class='control-label'>Expiration Month</label> 
                                    <input class='form-control card-expiry-month' placeholder='MM' size='2' type='text' minlength="2" maxlength="2">
                                </div>
                                <div class='col-xs-12 col-md-4 form-group expiration required'>
                                    <label class='control-label'>Expiration Year</label> 
                                    <input class='form-control card-expiry-year' placeholder='YYYY' size='4' type='text' minlength="4" maxlength="4">
                                </div>
                            </div>                   
