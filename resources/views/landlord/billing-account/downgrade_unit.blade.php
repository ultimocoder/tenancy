            ...
            @include('landlord_layouts.topbar')
                ...
                <div class="page-title">
                    ...
                    <div class="container-fluid">
                        ...
                        @else
                        <div class="mb-3">
                            <b>In order to lower you plan, your must deactivate {{(count($oldPropertyUnits) - $unit_number)}} out of your {{count($oldPropertyUnits)}} registered units. Please select the units you wish to deactivate.</b>
                        </div>
                        @endif
