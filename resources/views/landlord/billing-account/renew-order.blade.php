        ...
        <div class="rightside">
            <div class="top">
                ...
                <div class="withButton">
                    ...
                    <form class="page-card mx-auto" action="{{route('landlord.account.subscription.store')}}" method="post">
                        @csrf
                    <div class="container">
                        <div class="row mb-4">
                            <div class="col-sm-8">
                                <div class="page-card">
                                    ...
                                    <div class="box-style-1">
                                        ...
                                        <div>
                                            ...
                                            <div class="fs-14 fw-semibold text-black-50">Pay @if($cycle == 'monthly')  ${{number_format(((25 * $unit) - $discount), 2)}}  @else ${{number_format(((25 * $unit) - $discount) *12, 2)}}  @endif {{$cycle}} + application taxes</div>
                                        </div>
                                    </div>
                                    <div class="box-style-1">
                                    ...
                                    <div class="text-black-50">
                                        ...
                                        To ensure uninterrupted service, your subscription will be set to continuous auto-renewal payments of @if($cycle == 'monthly')  ${{number_format(((25 * $unit) - $discount), 2)}}  @else ${{number_format(((25 * $unit) - $discount) *12, 2)}}  @endif per {{$cycle}} (plus applicable taxes),
                                        with your next payment due on {{$nextDueDateTime}}. This means you authorize us to take this amount from your account each {{$cycle}}.
                            ...
                            <div class="col-sm-4">
                                <div class="page-card">
                                    ...
                                    <table class="table fs-16">
                                        ...
                                        <tr><td>Subtotal</td><td class="text-end">@if($cycle == 'monthly')  ${{number_format(((25 * $unit) - $discount), 2)}}  @else ${{number_format(((25 * $unit) - $discount) *12, 2)}}  @endif</td></tr>
                                        <tr><td>Sales Tax</td><td class="text-end">$0.00</td></tr>
                                        <tr><td class="fs-20 fw-semibold">Due Today</td><td class="text-end fs-20 fw-semibold">@if($cycle == 'monthly')  ${{number_format(((25 * $unit) - $discount), 2)}}  @else ${{number_format(((25 * $unit) - $discount) *12, 2)}}  @endif</td></tr>
                                    </table>
                                </div>
                            </div>
                        </div>
