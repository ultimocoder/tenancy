                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="amount" value="{{ old('amount') }}" id="price"  placeholder="Enter amount" class="form-control form-control @error('amount') is-invalid @enderror" title="Please enter a valid price (e.g., $10.00)">
                                    @error('amount')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
