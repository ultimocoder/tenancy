                            ...
                            <div class="col-sm-6">
                                <div class="page-card">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="unit[]" class="unitNumber form-control form-control-sm" value="{{$unit->unit_name}}" placeholder="Enter Unit Name" value="A1">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <input type="hidden" name="currentValue" id="currentValue" value="{{$subscription->quantity}}">
                                    </div>
