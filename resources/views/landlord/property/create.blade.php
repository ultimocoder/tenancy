                ...
                <div class="page">
                    ...
                    <div class="page-card mx-auto" style="width: 600px;" id="PropertyDetails">
                        ...
                        <div class="form-group">
                            ...
                            <input name="address" id="address" class="form-control form-control-sm" placeholder="Enter Address"></input>
                    ...
                    <div class="page-card mx-auto d-none" style="width: 600px;" id="EnterUnits">
                        ...
                        @endif
                            ...
                            <input type="hidden" name="currentValue" id="currentValue" value="{{$remainingUnits - 1}}">
                        </div>
