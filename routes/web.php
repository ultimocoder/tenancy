...
Route::post('/landlord/property/unit/delete', [App\Http\Controllers\Landlord\PropertyController::class, 'deletePropertyUnit'])->name('landlord.property.unit.delete');
...
Route::post('/landlord/tenant/delete', [App\Http\Controllers\Landlord\TenantController::class, 'tenantDelete'])->name('landlord.tenant.delete');
...
//Route::post('/landlord/account/subscription/update', [App\Http\Controllers\Landlord\AccountController::class, 'SubscriptionUpdateTemp'])->name('landlord.account.subscription.update');
