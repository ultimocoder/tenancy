...
{   
    ...
    public function index(request $request){
        ...
        if($customer){
            ...
            $user->unique_id = $this->generateAccountId();
    ...
    public function stripeCheckoutSuccess(Request $request)
    {
        ...
        if($customer){
         ...
         if($session){
            ...
            $current_date_time_temp = strtotime($current_date_time);
            $next_due_date_time = date('Y-m-d H:i:s', strtotime('+1 month', $current_date_time_temp));
           ...
           $subscription->trial_ends_at = $next_due_date_time;
           $subscription->created_at = $current_date_time;
           $subscription->save();
         }
